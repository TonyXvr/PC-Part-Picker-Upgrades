...
import { removeComponentFromBuild, updateBuildName, formatPrice } from "~/utils/build";
...
export default function BuildPage() {
  const { currentBuild, totalPrice, compatibility } = useLoaderData<typeof loader>();
              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="mb-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-medium text-gray-900">{Object.keys(currentBuild.components).length}</span>
                  </div>
                </div>
                
                <div className={`p-4 rounded-md mb-4 ${compatibility.compatible ? 'bg-green-50' : 'bg-red-50'}`}>
                  <div className="flex">
                    {compatibility.compatible ? (
                      <>
                        ...
                        <div className="ml-3">
                          <h3 className="text-sm font-medium text-green-800">All components are compatible</h3>
                        </div>
                      </>
                    ) : (
                      <>
